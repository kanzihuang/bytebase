...
var file_store_idp_proto_rawDesc = []byte{
	...
	0x50, 0x53, 0x10, 0x02, 0x2a, 0x52, 0x0a, 0x0f, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x32, 0x41, 0x75,
...
var file_store_idp_proto_goTypes = []interface{}{
	...
	(OAuth2AuthStyle)(0),                 // 2: bytebase.store.OAuth2AuthStyle
...
var file_store_idp_proto_depIdxs = []int32{
	...
	2, // 4: bytebase.store.OAuth2IdentityProviderConfig.auth_style:type_name -> bytebase.store.OAuth2AuthStyle
	7, // 5: bytebase.store.OIDCIdentityProviderConfig.field_mapping:type_name -> bytebase.store.FieldMapping
	2, // 6: bytebase.store.OIDCIdentityProviderConfig.auth_style:type_name -> bytebase.store.OAuth2AuthStyle
	1, // 7: bytebase.store.LDAPIdentityProviderConfig.security_protocol:type_name -> bytebase.store.SecurityProtocol
